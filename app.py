...
<style>
    ...
    .emission-stat {height: 250px; text-align: left; padding: 20px; border-radius: 10px; margin: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.5);}
    ...
    .insight-card {background-color: #1F2633; padding: 15px; border-radius: 5px; margin: 10px 0; border-left: 5px solid #3498DB;}
    table th {background-color: #1F2633}
</style>
""",
...
def main():
    ...
    if page == "Home":
        st.title("Welcome to Vehicle CO2 Emission Predictor")
        ...
        with col4:
            st.markdown(
                """
                <div class="insight-card">
                    <h4 style="margin-bottom: -30px">Transmission Type</h4>
        ...
        st.write(
            """
            The Vehicle CO2 Emission Predictor is powered by the **Fuel Consumption Ratings 2023** dataset, 
        ...
        with col2:
            st.markdown(
                ...
                <div class="emission-stat moderate-emission">
                    ...
                    <p>Average-performing vehicles in terms of emissions. Most conventional sedans and smaller SUVs fall into this category.</p>
                </div>
                """,
                unsafe_allow_html=True,
            )
        ...
        st.write(
            "Enter vehicle details to predict its emission category. Fields marked with * are required."
        )
        with st.expander("Understanding Vehicle Specifications"):
            st.markdown(
                """
                ...
                <table style="width:100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">Model</td>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">
                            Specific vehicle model name. May include:<br>
                    ...
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">Transmission</td>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">
                            Transmission type and number of gears (e.g., A6, M5):<br>
                            - A: Automatic<br>
                    ...
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">Fuel Type</td>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">
                            Type of fuel used:<br>
                    ...
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">Fuel Consumption</td>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">
                            Fuel usage in litres per 100 km (L/100 km):<br>
                            - City: Urban driving<br>
                            - Highway: Highway driving<br>
                            - Combined: 55% city, 45% highway (also in miles per imperial gallon, mpg)
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">CO2 Emissions</td>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">
                            Tailpipe carbon dioxide emissions in grams per kilometre (g/km) for combined city and highway driving.
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">CO2 Rating</td>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">
                            Tailpipe CO2 emissions rated on a scale from 1 (worst) to 10 (best).
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">Smog Rating</td>
                        <td style="padding: 10px; border-bottom: 1px solid #34495E;">
                            Tailpipe emissions of smog-forming pollutants rated on a scale from 1 (worst) to 10 (best).
                        </td>
                    </tr>
                </table>
                """,
        ...
        with st.form("prediction_form"):
            ...
            with col1:
                ...
                transmission = st.text_input(
                    ...
                    placeholder="Enter A6 for 6-speed automatic or M5 for 5-speed manual",
                )
        ...
        if submitted:
            ...
            if missing_fields:
                ...
                try:
                    ...
                    available_features = [
                        f for f in selected_features if f in input_data.columns
                    ]
                    if not available_features:
                        raise ValueError("No valid features available for prediction")
                    X_input = input_data[available_features].values
                    ...
                    if hasattr(model_data["best_model"], "predict_proba"):
                        proba = model_data["best_model"].predict_proba(X_input_scaled)[
                            0
                        ]
                        proba_dict = {
